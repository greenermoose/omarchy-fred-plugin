...
| `fred.keyboard` | `v0.1.0` | Keyboard shortcut explorer: draws your actual keyboard, lights up keys as you press them, and maps combinations to the commands they run | Available (In testing) |
